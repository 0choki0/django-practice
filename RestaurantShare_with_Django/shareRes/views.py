...
def Delete_restaurant(request):
    ...
    restaurant = Restaurant.objects.get(id=res_id)
    restaurant.delete()
    return HttpResponseRedirect(reverse('shareRes:index'))
...
def Update_restaurant(request):
    ...
    before_restaurant.restaurant_name = request.POST['resTitle']
    before_restaurant.restaurant_link = request.POST['resLink']
    before_restaurant.restaurant_content = request.POST['resContent']
    before_restaurant.restaurant_keyword = request.POST['resLoc']
    before_restaurant.save()

    return HttpResponseRedirect(reverse('shareRes:resDetailPage', kwargs={'res_id':resId}))
...
def Create_category(request):
    ...
    new_category.save()
    return HttpResponseRedirect(reverse('shareRes:cateCreatePage'))
